...
module.exports = elaina = async (elaina, mek) => {
	try {
        ...
        //fake reply
			let ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6285655620413-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: thumbnail, surface: 200, message: `${botname} \nBy ${ownername}`, orderTitle: 'zeeoneofc', sellerJid: '0@s.whatsapp.net'}},sendEphemeral: true}
      	  let fdoc = {key : {participant : '0@s.whatsapp.net'},message: {documentMessage: {title: ` ${ownername}`,jpegThumbnail: thumbnail}}}
   	     let fvn = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6285655620413-1613049930@g.us" } : {})},message: { "audioMessage": {"mimetype":"audio/ogg; codecs=opus","seconds":99999,"ptt": "true"}} } 
	        let fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6285655620413-1613049930@g.us" } : {})},message: {"videoMessage": { "title":` ${ownername}`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `${botname} \nBy ${ownername}`, 'jpegThumbnail': thumbnail}}}
			...
			let fvideo = {key: { fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6285655620413-1613049930@g.us" } : {}) },message: { "videoMessage": { "title":` ${ownername}`, "h": `Hmm`,'seconds': '99999', 'caption': ` ${ownername}`, 'jpegThumbnail': thumbnail}}}
			...
			let fkontak = { key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6285655620413-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': ` ${ownername}`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${ownername},;;;\nFN:${ownername},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumbnail, thumbnail: thumbnail,sendEphemeral: true}}}
