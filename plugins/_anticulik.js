...
export async function all(m) {
    ...
    if ((m.mtype === 'groupInviteMessage' || m.text.startsWith('https://chat.whatsapp.com') || m.text.startsWith('Buka tautan ini')) && !m.isBaileys && !m.isGroup) {
        ...
        ┊⫹⫺ Normal: 5k/grup (1 bulan)
        ┊⫹⫺ Standar: 10k/grup (2 bulan)
        ┊⫹⫺ Pro: 15k/grup (4 bulan)                                                      
        ┊⫹⫺ Vip: = 20k/grup (12 bulan)
        ╰═┅═━––––––๑
        ...
        ┊⫹⫺ Pro: 5k (4 bulan)
        ┊⫹⫺ Vip: 10k (8 bulan)                                               
        ┊⫹⫺ Permanent: = 15k (Unlimited)
        ╰═┅═━––––––๑
        
        ⫹⫺ PAYMENT:
        • Pulsa Telkomsel: [085655620413]
        • Dana: [08165466368]
        • Gopay: [08165466368]
        • Ovo: [-]
        • Saweria: [https://saweria.co/Maslent]
